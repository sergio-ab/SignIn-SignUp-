...
*/
// ==========================================================
// |   FUNCIÓN "cambiarPropiedadEstilo"                     |
// ==========================================================


(function cambiarEstiloImput() {
        const imputForm= document.getElementById("signupForm");
        const imputChange = imputForm.getElementsByTagName("input");
            for (let i = 0; i < imputChange.length; i++) {
                imputChange[i].style.font-size = "1.25rem";
        }
})();
